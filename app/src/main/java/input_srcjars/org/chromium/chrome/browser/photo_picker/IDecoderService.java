...
public interface IDecoderService extends android.os.IInterface
{
  ...
  public static class Default implements org.chromium.chrome.browser.photo_picker.IDecoderService
  {
    /**
       * Decode an image.
  ...
  public static abstract class Stub extends android.os.Binder implements org.chromium.chrome.browser.photo_picker.IDecoderService
  {
    ...
    private static class Proxy implements org.chromium.chrome.browser.photo_picker.IDecoderService
    {
      ...
      public static org.chromium.chrome.browser.photo_picker.IDecoderService sDefaultImpl;
    }
    static final int TRANSACTION_decodeImage = (android.os.IBinder.FIRST_CALL_TRANSACTION + 0);
    public static boolean setDefaultImpl(org.chromium.chrome.browser.photo_picker.IDecoderService impl) {
    ...
    public static org.chromium.chrome.browser.photo_picker.IDecoderService getDefaultImpl() {
