...
@IntDef({
    ...
    ContentSettingsType.ACCESSIBILITY_EVENTS, ContentSettingsType.PLUGINS_DATA,
    ...
    ContentSettingsType.VR, ContentSettingsType.AR, ContentSettingsType.NUM_TYPES
})
...
public @interface ContentSettingsType {
   ...
   */
  int INTENT_PICKER_DISPLAY = 39;
  /**
   * Used to store whether to allow a website to detect user active/idle state.
   */
  int IDLE_DETECTION = 40;
  /**
   ...
   * worked out.
   */
  int WAKE_LOCK_SCREEN = 47;
  int WAKE_LOCK_SYSTEM = 48;
  /**
