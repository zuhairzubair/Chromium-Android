...
@IntDef({
    ConnectionSecurityLevel.NONE, ConnectionSecurityLevel.EV_SECURE, ConnectionSecurityLevel.SECURE,
...
public @interface ConnectionSecurityLevel {
   ...
   * instead in most cases. HTTP_SHOW_WARNING = 1, HTTPS with valid EV cert.
   */
  int EV_SECURE = 2;
  /**
