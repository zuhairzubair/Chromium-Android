...
public final class ActionsProto {
  ...
  public  static final class Actions extends
     ...
     * <code>optional .components.feed.core.proto.ui.piet.Action on_force_touch_action = 5;</code>
     */
    private void setOnForceTouchAction(
        org.chromium.components.feed.core.proto.ui.piet.ActionsProto.Action.Builder builderForValue) {
      onForceTouchAction_ = builderForValue.build();
      bitField0_ |= 0x00000004;
    }
    /**
     * <pre>
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (((bitField0_ & 0x00000004) == 0x00000004)) {
        output.writeMessage(5, getOnForceTouchAction());
      }
    ...
    public int getSerializedSize() {
      ...
      if (((bitField0_ & 0x00000004) == 0x00000004)) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(5, getOnForceTouchAction());
      }
    ...
    public static final class Builder extends
      ...
      public Builder setOnForceTouchAction(
          org.chromium.components.feed.core.proto.ui.piet.ActionsProto.Action.Builder builderForValue) {
        copyOnWrite();
        instance.setOnForceTouchAction(builderForValue);
        return this;
      }
      /**
       * <pre>
    ...
    protected final Object dynamicMethod(
      ...
      switch (method) {
        ...
        case IS_INITIALIZED: {
          ...
          if (hasOnForceTouchAction()) {
            if (!getOnForceTouchAction().isInitialized()) {
              if (shouldMemoize) {
                memoizedIsInitialized = 0;
              }
              return null;
        ...
        case VISIT: {
          ...
          org.chromium.components.feed.core.proto.ui.piet.ActionsProto.Actions other = (org.chromium.components.feed.core.proto.ui.piet.ActionsProto.Actions) arg1;
          ...
          onForceTouchAction_ = visitor.visitMessage(onForceTouchAction_, other.onForceTouchAction_);
          ...
          try {
            ...
            while (!done) {
              ...
              switch (tag) {
                ...
                case 10: {
                  org.chromium.components.feed.core.proto.ui.piet.ActionsProto.Action.Builder subBuilder = null;
                  if (((bitField0_ & 0x00000001) == 0x00000001)) {
                    subBuilder = onClickAction_.toBuilder();
                  }
                  onClickAction_ = input.readMessage(org.chromium.components.feed.core.proto.ui.piet.ActionsProto.Action.parser(), extensionRegistry);
                  if (subBuilder != null) {
                ...
                case 18: {
                  ...
                  onLongClickAction_ = input.readMessage(org.chromium.components.feed.core.proto.ui.piet.ActionsProto.Action.parser(), extensionRegistry);
                  if (subBuilder != null) {
                ...
                case 26: {
                  ...
                  onViewActions_.add(
                      input.readMessage(org.chromium.components.feed.core.proto.ui.piet.ActionsProto.VisibilityAction.parser(), extensionRegistry));
                  break;
                }
                case 34: {
                  if (!onHideActions_.isModifiable()) {
                ...
                case 42: {
                  org.chromium.components.feed.core.proto.ui.piet.ActionsProto.Action.Builder subBuilder = null;
                  if (((bitField0_ & 0x00000004) == 0x00000004)) {
                    subBuilder = onForceTouchAction_.toBuilder();
                  }
                  onForceTouchAction_ = input.readMessage(org.chromium.components.feed.core.proto.ui.piet.ActionsProto.Action.parser(), extensionRegistry);
                  if (subBuilder != null) {
                    subBuilder.mergeFrom(onForceTouchAction_);
                    onForceTouchAction_ = subBuilder.buildPartial();
                  }
                  bitField0_ |= 0x00000004;
                  break;
                }
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (org.chromium.components.feed.core.proto.ui.piet.ActionsProto.Actions.class) {
              if (PARSER == null) {
  ...
  public  static final class Action extends
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
                        throws java.io.IOException {
      com.google.protobuf.GeneratedMessageLite
        .ExtendableMessage<org.chromium.components.feed.core.proto.ui.piet.ActionsProto.Action, org.chromium.components.feed.core.proto.ui.piet.ActionsProto.Action.Builder>
    ...
    protected final Object dynamicMethod(
      ...
      switch (method) {
        ...
        case VISIT: {
          Visitor visitor = (Visitor) arg0;
          org.chromium.components.feed.core.proto.ui.piet.ActionsProto.Action other = (org.chromium.components.feed.core.proto.ui.piet.ActionsProto.Action) arg1;
          if (visitor == com.google.protobuf.GeneratedMessageLite.MergeFromVisitor
              .INSTANCE) {
          }
          return this;
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (org.chromium.components.feed.core.proto.ui.piet.ActionsProto.Action.class) {
              if (PARSER == null) {
                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
              }
            }
  ...
  public  static final class VisibilityAction extends
    ...
    protected final Object dynamicMethod(
      ...
      switch (method) {
        ...
        case VISIT: {
          Visitor visitor = (Visitor) arg0;
          org.chromium.components.feed.core.proto.ui.piet.ActionsProto.VisibilityAction other = (org.chromium.components.feed.core.proto.ui.piet.ActionsProto.VisibilityAction) arg1;
            ...
            while (!done) {
              ...
              switch (tag) {
                ...
                case 18: {
                  ...
                  action_ = input.readMessage(org.chromium.components.feed.core.proto.ui.piet.ActionsProto.Action.parser(), extensionRegistry);
                  if (subBuilder != null) {
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (org.chromium.components.feed.core.proto.ui.piet.ActionsProto.VisibilityAction.class) {
              if (PARSER == null) {
                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
              }
            }
