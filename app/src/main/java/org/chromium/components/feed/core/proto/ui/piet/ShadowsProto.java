    ...
    protected final Object dynamicMethod(
      ...
      switch (method) {
        ...
        case VISIT: {
          ...
          org.chromium.components.feed.core.proto.ui.piet.ShadowsProto.Shadow other = (org.chromium.components.feed.core.proto.ui.piet.ShadowsProto.Shadow) arg1;
          ...
          try {
            ...
            while (!done) {
              ...
              switch (tag) {
                ...
                case 10: {
                  org.chromium.components.feed.core.proto.ui.piet.ShadowsProto.BoxShadow.Builder subBuilder = null;
                  if (((bitField0_ & 0x00000001) == 0x00000001)) {
                    subBuilder = boxShadow_.toBuilder();
                  }
                  boxShadow_ = input.readMessage(org.chromium.components.feed.core.proto.ui.piet.ShadowsProto.BoxShadow.parser(), extensionRegistry);
                  if (subBuilder != null) {
                ...
                case 18: {
                  org.chromium.components.feed.core.proto.ui.piet.ShadowsProto.ElevationShadow.Builder subBuilder = null;
                  if (((bitField0_ & 0x00000002) == 0x00000002)) {
                    subBuilder = elevationShadow_.toBuilder();
                  }
                  elevationShadow_ = input.readMessage(org.chromium.components.feed.core.proto.ui.piet.ShadowsProto.ElevationShadow.parser(), extensionRegistry);
                  if (subBuilder != null) {
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (org.chromium.components.feed.core.proto.ui.piet.ShadowsProto.Shadow.class) {
              if (PARSER == null) {
  ...
  public  static final class BoxShadow extends
    ...
    protected final Object dynamicMethod(
      ...
      switch (method) {
        ...
        case VISIT: {
          Visitor visitor = (Visitor) arg0;
          org.chromium.components.feed.core.proto.ui.piet.ShadowsProto.BoxShadow other = (org.chromium.components.feed.core.proto.ui.piet.ShadowsProto.BoxShadow) arg1;
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (org.chromium.components.feed.core.proto.ui.piet.ShadowsProto.BoxShadow.class) {
              if (PARSER == null) {
                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
              }
            }
  ...
  public  static final class ElevationShadow extends
    ...
    protected final Object dynamicMethod(
      ...
      switch (method) {
        ...
        case VISIT: {
          Visitor visitor = (Visitor) arg0;
          org.chromium.components.feed.core.proto.ui.piet.ShadowsProto.ElevationShadow other = (org.chromium.components.feed.core.proto.ui.piet.ShadowsProto.ElevationShadow) arg1;
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (org.chromium.components.feed.core.proto.ui.piet.ShadowsProto.ElevationShadow.class) {
              if (PARSER == null) {
                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
              }
            }
