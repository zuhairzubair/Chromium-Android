...
public final class TokenProto {
  ...
  public interface TokenOrBuilder extends
      // @@protoc_insertion_point(interface_extends:components.feed.core.proto.wire.Token)
   ...
   * </pre>
   *
   * Protobuf type {@code components.feed.core.proto.wire.Token}
   */
  public  static final class Token extends
      com.google.protobuf.GeneratedMessageLite<
          Token, Token.Builder> implements
      // @@protoc_insertion_point(message_implements:components.feed.core.proto.wire.Token)
      TokenOrBuilder {
    private Token() {
  ...
  bitField0_ |= 0x00000001;
    ...
    public static final class Builder extends
        ...
        // @@protoc_insertion_point(builder_implements:components.feed.core.proto.wire.Token)
      ...
      // @@protoc_insertion_point(builder_scope:components.feed.core.proto.wire.Token)
    }
    protected final Object dynamicMethod(
      ...
      switch (method) {
        ...
        case VISIT: {
          ...
          org.chromium.components.feed.core.proto.wire.TokenProto.Token other = (org.chromium.components.feed.core.proto.wire.TokenProto.Token) arg1;
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (org.chromium.components.feed.core.proto.wire.TokenProto.Token.class) {
              if (PARSER == null) {
    ...
    // @@protoc_insertion_point(class_scope:components.feed.core.proto.wire.Token)
