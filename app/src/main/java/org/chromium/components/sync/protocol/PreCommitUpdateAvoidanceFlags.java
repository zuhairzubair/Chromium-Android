...
public  final class PreCommitUpdateAvoidanceFlags extends
  ...
  protected final Object dynamicMethod(
    ...
    switch (method) {
      ...
      case VISIT: {
        ...
        org.chromium.components.sync.protocol.PreCommitUpdateAvoidanceFlags other = (org.chromium.components.sync.protocol.PreCommitUpdateAvoidanceFlags) arg1;
      ...
      case GET_PARSER: {
        if (PARSER == null) {    synchronized (org.chromium.components.sync.protocol.PreCommitUpdateAvoidanceFlags.class) {
            if (PARSER == null) {
  ...
  static {
    DEFAULT_INSTANCE = new PreCommitUpdateAvoidanceFlags();
