...
public  final class PriorityPreferenceSpecifics extends
  ...
  protected final Object dynamicMethod(
    ...
    switch (method) {
      ...
      case VISIT: {
        ...
        org.chromium.components.sync.protocol.PriorityPreferenceSpecifics other = (org.chromium.components.sync.protocol.PriorityPreferenceSpecifics) arg1;
      ...
      case GET_PARSER: {
        if (PARSER == null) {    synchronized (org.chromium.components.sync.protocol.PriorityPreferenceSpecifics.class) {
            if (PARSER == null) {
  ...
  static {
    DEFAULT_INSTANCE = new PriorityPreferenceSpecifics();
