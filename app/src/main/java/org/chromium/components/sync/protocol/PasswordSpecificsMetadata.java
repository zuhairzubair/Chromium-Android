...
public  final class PasswordSpecificsMetadata extends
  ...
  protected final Object dynamicMethod(
    ...
    switch (method) {
      ...
      case VISIT: {
        ...
        org.chromium.components.sync.protocol.PasswordSpecificsMetadata other = (org.chromium.components.sync.protocol.PasswordSpecificsMetadata) arg1;
      ...
      case GET_PARSER: {
        if (PARSER == null) {    synchronized (org.chromium.components.sync.protocol.PasswordSpecificsMetadata.class) {
            if (PARSER == null) {
  ...
  static {
    DEFAULT_INSTANCE = new PasswordSpecificsMetadata();
