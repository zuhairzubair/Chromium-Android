...
public  final class UserConsentSpecifics extends
   ...
   * <code>optional .sync_pb.UserConsentTypes.AssistantActivityControlConsent assistant_activity_control_consent = 14;</code>
   */
  private void setAssistantActivityControlConsent(
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (consentCase_ == 14) {
      output.writeMessage(14, (org.chromium.components.sync.protocol.UserConsentTypes.AssistantActivityControlConsent) consent_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (consentCase_ == 14) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(14, (org.chromium.components.sync.protocol.UserConsentTypes.AssistantActivityControlConsent) consent_);
    }
  ...
  public static final class Builder extends
    ...
    public Builder setAssistantActivityControlConsent(
        org.chromium.components.sync.protocol.UserConsentTypes.AssistantActivityControlConsent.Builder builderForValue) {
      copyOnWrite();
      instance.setAssistantActivityControlConsent(builderForValue);
      return this;
    }
    /**
     * <code>optional .sync_pb.UserConsentTypes.AssistantActivityControlConsent assistant_activity_control_consent = 14;</code>
  ...
  protected final Object dynamicMethod(
    ...
    switch (method) {
      ...
      case VISIT: {
        ...
        org.chromium.components.sync.protocol.UserConsentSpecifics other = (org.chromium.components.sync.protocol.UserConsentSpecifics) arg1;
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 8: {
                ...
                org.chromium.components.sync.protocol.UserConsentSpecifics.Feature value = org.chromium.components.sync.protocol.UserConsentSpecifics.Feature.forNumber(rawValue);
                if (value == null) {
              ...
              case 114: {
                org.chromium.components.sync.protocol.UserConsentTypes.AssistantActivityControlConsent.Builder subBuilder = null;
                if (consentCase_ == 14) {
                  subBuilder = ((org.chromium.components.sync.protocol.UserConsentTypes.AssistantActivityControlConsent) consent_).toBuilder();
                }
                consent_ =
                     input.readMessage(org.chromium.components.sync.protocol.UserConsentTypes.AssistantActivityControlConsent.parser(), extensionRegistry);
                if (subBuilder != null) {
                  subBuilder.mergeFrom((org.chromium.components.sync.protocol.UserConsentTypes.AssistantActivityControlConsent) consent_);
                  consent_ = subBuilder.buildPartial();
                }
                consentCase_ = 14;
                break;
      ...
      case GET_PARSER: {
        if (PARSER == null) {    synchronized (org.chromium.components.sync.protocol.UserConsentSpecifics.class) {
            if (PARSER == null) {
  ...
  static {
    DEFAULT_INSTANCE = new UserConsentSpecifics();
