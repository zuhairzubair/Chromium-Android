    ...
    protected final Object dynamicMethod(
      ...
      switch (method) {
        ...
        case VISIT: {
          ...
          org.chromium.chrome.browser.thumbnail.generator.ThumbnailCacheEntry.ContentId other = (org.chromium.chrome.browser.thumbnail.generator.ThumbnailCacheEntry.ContentId) arg1;
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (org.chromium.chrome.browser.thumbnail.generator.ThumbnailCacheEntry.ContentId.class) {
              if (PARSER == null) {
  ...
  bitField0_ |= 0x00000004;
    ...
    protected final Object dynamicMethod(
      ...
      switch (method) {
        ...
        case VISIT: {
          Visitor visitor = (Visitor) arg0;
          org.chromium.chrome.browser.thumbnail.generator.ThumbnailCacheEntry.ThumbnailEntry other = (org.chromium.chrome.browser.thumbnail.generator.ThumbnailCacheEntry.ThumbnailEntry) arg1;
          ...
          try {
            ...
            while (!done) {
              ...
              switch (tag) {
                ...
                case 10: {
                  org.chromium.chrome.browser.thumbnail.generator.ThumbnailCacheEntry.ContentId.Builder subBuilder = null;
                  if (((bitField0_ & 0x00000001) == 0x00000001)) {
                    subBuilder = contentId_.toBuilder();
                  }
                  contentId_ = input.readMessage(org.chromium.chrome.browser.thumbnail.generator.ThumbnailCacheEntry.ContentId.parser(), extensionRegistry);
                  if (subBuilder != null) {
        ...
        case GET_PARSER: {
          if (PARSER == null) {    synchronized (org.chromium.chrome.browser.thumbnail.generator.ThumbnailCacheEntry.ThumbnailEntry.class) {
              if (PARSER == null) {
                PARSER = new DefaultInstanceBasedParser(DEFAULT_INSTANCE);
              }
            }
