...
{
  /** Default implementation for IModuleEntryPoint. */
  public static class Default implements org.chromium.chrome.browser.customtabs.dynamicmodule.IModuleEntryPoint
  {
  ...
  public static abstract class Stub extends android.os.Binder implements org.chromium.chrome.browser.customtabs.dynamicmodule.IModuleEntryPoint
  {
    ...
    private static class Proxy implements org.chromium.chrome.browser.customtabs.dynamicmodule.IModuleEntryPoint
    {
      ...
      @Override public void init(org.chromium.chrome.browser.customtabs.dynamicmodule.IModuleHost moduleHost) throws android.os.RemoteException
      {
        ...
        try {
          ...
          if (!_status && getDefaultImpl() != null) {
            getDefaultImpl().init(moduleHost);
            return;
          }
      ...
      @Override public int getModuleVersion() throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          boolean _status = mRemote.transact(Stub.TRANSACTION_getModuleVersion, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().getModuleVersion();
          }
          _reply.readException();
      ...
      @Override public int getMinimumHostVersion() throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          boolean _status = mRemote.transact(Stub.TRANSACTION_getMinimumHostVersion, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().getMinimumHostVersion();
          }
          _reply.readException();
          _result = _reply.readInt();
        }
      ...
      @Override public org.chromium.chrome.browser.customtabs.dynamicmodule.IActivityDelegate createActivityDelegate(org.chromium.chrome.browser.customtabs.dynamicmodule.IActivityHost activityHost) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_createActivityDelegate, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().createActivityDelegate(activityHost);
          }
          _reply.readException();
      ...
      @Override public void onBundleReceived(org.chromium.chrome.browser.customtabs.dynamicmodule.IObjectWrapper args) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_onBundleReceived, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            getDefaultImpl().onBundleReceived(args);
            return;
          }
          _reply.readException();
        }
      ...
      public static org.chromium.chrome.browser.customtabs.dynamicmodule.IModuleEntryPoint sDefaultImpl;
    }
    ...
    public static boolean setDefaultImpl(org.chromium.chrome.browser.customtabs.dynamicmodule.IModuleEntryPoint impl) {
    ...
    public static org.chromium.chrome.browser.customtabs.dynamicmodule.IModuleEntryPoint getDefaultImpl() {
