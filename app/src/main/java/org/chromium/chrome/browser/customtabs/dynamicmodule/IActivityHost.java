...
{
  /** Default implementation for IActivityHost. */
  public static class Default implements org.chromium.chrome.browser.customtabs.dynamicmodule.IActivityHost
  {
  ...
  public static abstract class Stub extends android.os.Binder implements org.chromium.chrome.browser.customtabs.dynamicmodule.IActivityHost
  {
    ...
    private static class Proxy implements org.chromium.chrome.browser.customtabs.dynamicmodule.IActivityHost
    {
      ...
      @Override public org.chromium.chrome.browser.customtabs.dynamicmodule.IObjectWrapper getActivityContext() throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_getActivityContext, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().getActivityContext();
          }
      ...
      @Override public void setBottomBarView(org.chromium.chrome.browser.customtabs.dynamicmodule.IObjectWrapper bottomBarView) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_setBottomBarView, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            getDefaultImpl().setBottomBarView(bottomBarView);
            return;
          }
          _reply.readException();
        }
      ...
      @Override public void setOverlayView(org.chromium.chrome.browser.customtabs.dynamicmodule.IObjectWrapper overlayView) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_setOverlayView, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            getDefaultImpl().setOverlayView(overlayView);
            return;
          }
          _reply.readException();
        }
      ...
      @Override public void setBottomBarHeight(int heightInPx) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_setBottomBarHeight, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            getDefaultImpl().setBottomBarHeight(heightInPx);
            return;
          }
          _reply.readException();
        }
      ...
      @Override public void loadUri(android.net.Uri uri) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_loadUri, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            getDefaultImpl().loadUri(uri);
            return;
          }
          _reply.readException();
        }
      ...
      @Override public void setTopBarView(org.chromium.chrome.browser.customtabs.dynamicmodule.IObjectWrapper topBarView) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_setTopBarView, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            getDefaultImpl().setTopBarView(topBarView);
            return;
          }
          _reply.readException();
        }
      ...
      @Override public void setTopBarHeight(int heightInPx) throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          _data.writeInt(heightInPx);
          boolean _status = mRemote.transact(Stub.TRANSACTION_setTopBarHeight, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            getDefaultImpl().setTopBarHeight(heightInPx);
            return;
          }
          _reply.readException();
        }
      ...
      @Override public boolean requestPostMessageChannel(android.net.Uri postMessageOrigin) throws android.os.RemoteException
      {
        ...
        try {
          ...
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().requestPostMessageChannel(postMessageOrigin);
          }
          _reply.readException();
      ...
      @Override public int postMessage(java.lang.String message) throws android.os.RemoteException
      {
        ...
        try {
          ...
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().postMessage(message);
          }
          _reply.readException();
      ...
      @Override public void setTopBarMinHeight(int heightInPx) throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          _data.writeInt(heightInPx);
          boolean _status = mRemote.transact(Stub.TRANSACTION_setTopBarMinHeight, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            getDefaultImpl().setTopBarMinHeight(heightInPx);
            return;
          }
          _reply.readException();
        }
      ...
      public static org.chromium.chrome.browser.customtabs.dynamicmodule.IActivityHost sDefaultImpl;
    }
    ...
    public static boolean setDefaultImpl(org.chromium.chrome.browser.customtabs.dynamicmodule.IActivityHost impl) {
    ...
    public static org.chromium.chrome.browser.customtabs.dynamicmodule.IActivityHost getDefaultImpl() {
