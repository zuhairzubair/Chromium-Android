...
class NetworkService_Internal {
    ...
    private static final int UPDATE_LEGACY_TLS_CONFIG_ORDINAL = 16;

    private static final int ON_CERT_DB_CHANGED_ORDINAL = 17;

    private static final int ADD_CORB_EXCEPTION_FOR_PLUGIN_ORDINAL = 18;

    private static final int REMOVE_CORB_EXCEPTION_FOR_PLUGIN_ORDINAL = 19;
