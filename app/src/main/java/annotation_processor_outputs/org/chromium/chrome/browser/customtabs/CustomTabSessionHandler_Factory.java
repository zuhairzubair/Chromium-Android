...
public final class CustomTabSessionHandler_Factory implements Factory<CustomTabSessionHandler> {
  ...
  public CustomTabSessionHandler get() {
    return provideInstance(
        ...
        sessionDataHolderProvider);
  }

  public static CustomTabSessionHandler provideInstance(
      Provider<BrowserServicesIntentDataProvider> intentDataProvider,
      Provider<CustomTabActivityTabProvider> tabProvider,
      Provider<CustomTabToolbarCoordinator> toolbarCoordinatorProvider,
      Provider<CustomTabBottomBarDelegate> bottomBarDelegateProvider,
      ...
      Provider<ActivityLifecycleDispatcher> lifecycleDispatcherProvider,
      Provider<SessionDataHolder> sessionDataHolderProvider) {
    return new CustomTabSessionHandler(
        intentDataProvider.get(),
        tabProvider.get(),
        DoubleCheck.lazy(toolbarCoordinatorProvider),
        DoubleCheck.lazy(bottomBarDelegateProvider),
        intentHandlerProvider.get(),
        connectionProvider.get(),
        activityProvider.get(),
        lifecycleDispatcherProvider.get(),
        sessionDataHolderProvider.get());
  }
  ...
  public static CustomTabSessionHandler_Factory create(
      ...
      Provider<ActivityLifecycleDispatcher> lifecycleDispatcherProvider,
      Provider<SessionDataHolder> sessionDataHolderProvider) {
    return new CustomTabSessionHandler_Factory(
        intentDataProvider,
        tabProvider,
        toolbarCoordinatorProvider,
        bottomBarDelegateProvider,
  ...
  public static CustomTabSessionHandler newCustomTabSessionHandler(
