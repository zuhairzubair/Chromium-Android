...
public final class ImmersiveModeController_Factory implements Factory<ImmersiveModeController> {
  ...
  public ImmersiveModeController get() {
    return provideInstance(lifecycleDispatcherProvider, activityProvider);
  }

  public static ImmersiveModeController provideInstance(
      Provider<ActivityLifecycleDispatcher> lifecycleDispatcherProvider,
      Provider<Activity> activityProvider) {
    return new ImmersiveModeController(lifecycleDispatcherProvider.get(), activityProvider.get());
  }
  ...
  public static ImmersiveModeController newImmersiveModeController(
