...
public final class CustomTabNavigationEventObserver_Factory
    implements Factory<CustomTabNavigationEventObserver> {
  ...
  public static CustomTabNavigationEventObserver provideInstance(
      Provider<BrowserServicesIntentDataProvider> intentDataProvider,
      Provider<CustomTabsConnection> connectionProvider) {
    return new CustomTabNavigationEventObserver(intentDataProvider.get(), connectionProvider.get());
  }
  ...
  public static CustomTabNavigationEventObserver newCustomTabNavigationEventObserver(
