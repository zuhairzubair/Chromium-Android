...
public final class DefaultCustomTabIntentHandlingStrategy_Factory
    implements Factory<DefaultCustomTabIntentHandlingStrategy> {
  ...
  public DefaultCustomTabIntentHandlingStrategy get() {
    return provideInstance(
        ...
        navigationEventObserverProvider,
        customTabObserverProvider);
  }

  public static DefaultCustomTabIntentHandlingStrategy provideInstance(
      Provider<CustomTabActivityTabProvider> tabProvider,
      Provider<CustomTabActivityNavigationController> navigationControllerProvider,
      Provider<CustomTabNavigationEventObserver> navigationEventObserverProvider,
      Provider<CustomTabObserver> customTabObserverProvider) {
    return new DefaultCustomTabIntentHandlingStrategy(
        tabProvider.get(),
        navigationControllerProvider.get(),
        navigationEventObserverProvider.get(),
  ...
  public static DefaultCustomTabIntentHandlingStrategy_Factory create(
      ...
      Provider<CustomTabNavigationEventObserver> navigationEventObserverProvider,
      Provider<CustomTabObserver> customTabObserverProvider) {
    return new DefaultCustomTabIntentHandlingStrategy_Factory(
        tabProvider,
        navigationControllerProvider,
        navigationEventObserverProvider,
        customTabObserverProvider);
  ...
  public static DefaultCustomTabIntentHandlingStrategy newDefaultCustomTabIntentHandlingStrategy(
      CustomTabActivityTabProvider tabProvider,
      CustomTabActivityNavigationController navigationController,
      CustomTabNavigationEventObserver navigationEventObserver,
      Lazy<CustomTabObserver> customTabObserver) {
    return new DefaultCustomTabIntentHandlingStrategy(
        tabProvider, navigationController, navigationEventObserver, customTabObserver);
  }
}
