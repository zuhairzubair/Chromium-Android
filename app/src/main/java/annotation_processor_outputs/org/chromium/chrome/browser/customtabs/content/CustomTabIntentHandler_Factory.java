...
public final class CustomTabIntentHandler_Factory implements Factory<CustomTabIntentHandler> {
  ...
  private final Provider<CustomTabIntentHandler.IntentIgnoringCriterion>
      intentIgnoringCriterionProvider;

  private final Provider<Context> contextProvider;

  public CustomTabIntentHandler_Factory(
  ...
  public CustomTabIntentHandler get() {
    return provideInstance(
        tabProvider,
        intentDataProvider,
        handlingStrategyProvider,
        intentIgnoringCriterionProvider,
        contextProvider);
  }

  public static CustomTabIntentHandler provideInstance(
      Provider<CustomTabActivityTabProvider> tabProvider,
      Provider<BrowserServicesIntentDataProvider> intentDataProvider,
      Provider<CustomTabIntentHandlingStrategy> handlingStrategyProvider,
      Provider<CustomTabIntentHandler.IntentIgnoringCriterion> intentIgnoringCriterionProvider,
    ...
    return new CustomTabIntentHandler(
        ...
        handlingStrategyProvider.get(),
        intentIgnoringCriterionProvider.get(),
        contextProvider.get());
  }
  ...
  public static CustomTabIntentHandler_Factory create(
      ...
      Provider<CustomTabIntentHandler.IntentIgnoringCriterion> intentIgnoringCriterionProvider,
      Provider<Context> contextProvider) {
    return new CustomTabIntentHandler_Factory(
        tabProvider,
        intentDataProvider,
        handlingStrategyProvider,
        intentIgnoringCriterionProvider,
  ...
  public static CustomTabIntentHandler newCustomTabIntentHandler(
      ...
      Context context) {
    return new CustomTabIntentHandler(
        tabProvider, intentDataProvider, handlingStrategy, intentIgnoringCriterion, context);
  }
}
