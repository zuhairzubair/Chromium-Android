...
public final class TrustedWebActivityBrowserControlsVisibilityManager_Factory
    implements Factory<TrustedWebActivityBrowserControlsVisibilityManager> {
  ...
  public static TrustedWebActivityBrowserControlsVisibilityManager provideInstance(
      Provider<TabObserverRegistrar> tabObserverRegistrarProvider,
      Provider<CustomTabActivityTabProvider> tabProvider,
      Provider<CustomTabToolbarCoordinator> toolbarCoordinatorProvider,
      Provider<CloseButtonVisibilityManager> closeButtonVisibilityManagerProvider,
  ...
  public static TrustedWebActivityBrowserControlsVisibilityManager_Factory create(
      ...
      Provider<CloseButtonVisibilityManager> closeButtonVisibilityManagerProvider,
      Provider<BrowserServicesIntentDataProvider> intentDataProvider) {
    return new TrustedWebActivityBrowserControlsVisibilityManager_Factory(
        tabObserverRegistrarProvider,
        tabProvider,
        toolbarCoordinatorProvider,
        closeButtonVisibilityManagerProvider,
  ...
  public static TrustedWebActivityBrowserControlsVisibilityManager
      newTrustedWebActivityBrowserControlsVisibilityManager(
